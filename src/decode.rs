...
///
/// Used internally by `#[ferrishot_knus(..., bytes)]` attribute. But can be used
...
///
/// Used internally by `#[ferrishot_knus(child)] x: bool,`. But can be used
/// manually for implementing [`DecodeScalar`](crate::traits::DecodeScalar).
...
impl<S: ErrorSpan> Context<S> {
    ...
    /// Set context value
    ///
    /// These values aren't used by the ferrishot_knus itself. But can be used by
